...
export default function BioAnalyserScreen() {
      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        >
          {analysing ? (
            ...
            <Text style={styles.primaryButtonText}>{COPY.bioAnalyser.analyseButton}</Text>
          )}
        </TouchableOpacity>
          ...
          <View style={styles.section}>
            ...
            >
              {generating ? (
                ...
                <Text style={styles.primaryButtonText}>{COPY.bioAnalyser.generateButton}</Text>
              )}
            </TouchableOpacity>
          </View>
        )}
        ...
        {openers.length > 0 && (
          <View style={styles.section}>
            ...
            {openers.map((opener, i) => (
              <OpenerCard key={i} text={opener} index={i} />
            ))}
          </View>
        )}
      </ScrollView>
